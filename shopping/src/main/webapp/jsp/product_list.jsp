	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<div class="col-md-2">
				...
				<p><a href="product_info.jsp" style='color:green'>冬瓜</a></p>
			...
			<div class="col-md-2">
				...
				<p><a href="product_info.jsp" style='color:green'>圆白菜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			...
			<div class="col-md-2">
				...
				<p><a href="product_info.jsp" style='color:green'>甜玉米</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			...
			<div class="col-md-2">
				...
				<p><a href="product_info.jsp" style='color:green'>胡萝卜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			<div class="col-md-2">
				<a href="product_info.jsp">
				...
				<p><a href="product_info.jsp" style='color:green'>芹菜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			...
			<div class="col-md-2">
				...
				<p><a href="product_info.jsp" style='color:green'>韭菜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			...
			<div class="col-md-2">
				...
				<p><a href="product_info.jsp" style='color:green'>香菜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			<div class="col-md-2">
				<a href="product_info.jsp">
				...
				<p><a href="product_info.jsp" style='color:green'>土豆</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			<div class="col-md-2">
				<a href="product_info.jsp">
